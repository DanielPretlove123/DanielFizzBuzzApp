...
namespace InfoTrackFizzBuzz.Application.FunctionalTests;

public class SqlTestcontainersTestDatabase : ITestDatabase
{
    private const string DefaultDatabase = "InfoTrackFizzBuzzTestDb";
    ...
    public async Task InitialiseAsync()
    {
        ...
        var options = new DbContextOptionsBuilder<ApplicationDbContext>()
            ...
            .ConfigureWarnings(warnings => warnings.Log(RelationalEventId.ModelValidationKeyDefaultValueWarning))
            .Options;
